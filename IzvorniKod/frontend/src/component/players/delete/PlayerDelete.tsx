...
export default function PlayerDelete({playerId}: Props) {
    ...
    const deleteClub = async () => {
        ...
        const response = await fetch("/players/delete/" + playerId, requestOptions);
            ...
            <div>
                <Dialog open={open} onClose={(event, reason) => {
                    ...
                    <DialogContent dividers>
                        Ako obrišete igrača, obrisat će se stranica profila igrača i bit ćete preusmjereni na početnu
                        stranicu.
                        Jeste li sigurni?
                    </DialogContent>
                    <DialogActions>
